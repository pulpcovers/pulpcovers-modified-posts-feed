...
<channel>
    ...
    public function register_settings() {
        register_setting( 'modified_posts_feed_settings', 'modified_posts_feed_slug' );
        register_setting( 'modified_posts_feed_settings', 'modified_posts_feed_limit' );
        register_setting( 'modified_posts_feed_settings', 'modified_posts_feed_post_types' );
        register_setting( 'modified_posts_feed_settings', 'modified_posts_feed_cache_enabled' );
        register_setting( 'modified_posts_feed_settings', 'modified_posts_feed_featured_image' );
        register_setting( 'modified_posts_feed_settings', 'modified_posts_feed_index_enabled' );
    }
